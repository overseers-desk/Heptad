...
The XKB variant identifier is a separate decision from the brand. See issue #4 for the plan to register Heptad as its own named variant rather than an in-place override.

## Roadmap

The path to upstream acceptance (an additive named XKB variant, packaging, and building adoption) is tracked in issue #4.
